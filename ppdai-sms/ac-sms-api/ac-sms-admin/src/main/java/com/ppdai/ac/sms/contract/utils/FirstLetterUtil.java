...
public class FirstLetterUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FirstLetterUtil.class);
    ...
    public static String cn2py(String SourceStr) {
        ...
        try {
            ...
            Result = "";
            logger.info("根据一个包含汉字的字符串返回一个汉字拼音首字母的字符串异常："+e);
        }
        return Result;
    }
