...
/**
 * Created by wangxiaomei02 on 2017/5/18.
 */
public class ServiceProviderRequest {
    ...
    private List<ProviderConfigRequest> configList;

    @ApiModelProperty(value = "服务商配置")
    public List<ProviderConfigRequest> getConfigList() {
        return configList;
    }

    public void setConfigList(List<ProviderConfigRequest> configList) {
