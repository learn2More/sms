...
@Component
public class BWReportDynamicScheduler  implements SchedulingConfigurer {

    private final static Logger logger = LoggerFactory.getLogger(BWReportDynamicScheduler.class);
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        taskRegistrar.addTriggerTask(() -> {
                ...
                // 定时任务触发，可修改定时任务的执行周期
                CronTrigger trigger = new CronTrigger(bwProviderProperties.getReportSchedulerCron());
