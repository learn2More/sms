...
import com.ppdai.ac.sms.api.provider.innerxw.ApplicationBoot;
import com.ppdai.ac.sms.api.provider.innerxw.domain.biz.XWProviderBiz;
import com.ppdai.ac.sms.api.provider.innerxw.domain.model.XWReportReturnCode;
...
public class XuanuInnerProviderTest {

    private final static Logger logger = LoggerFactory.getLogger(XuanuInnerProviderTest.class);
    ...
    public void send(){
        ...
        sendMsg.setName("new_yz");
        sendMsg.setPassword("123456");
    ...
    public void getReport(){
        String lusername="new_yx";
        String lpassword="123456";
        String lcmHost="172.17.41.174";
        int lcmPort=8090;
        String lwsHost="172.17.41.174";
        int lwsport=8088;
