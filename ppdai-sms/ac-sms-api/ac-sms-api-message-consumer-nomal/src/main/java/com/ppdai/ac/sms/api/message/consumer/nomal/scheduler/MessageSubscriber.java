package com.ppdai.ac.sms.api.message.consumer.nomal.scheduler;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.ppdai.ac.sms.api.message.consumer.nomal.enums.BizResult;
import com.ppdai.ac.sms.api.message.consumer.nomal.model.SMSMessageDTO;
...
//    }
    ...
    public boolean onMessageReceived(Message message) throws Exception {
        logger.info("消费normal消息,内容："+ JSONObject.toJSONString(message));
        try {
